...
# You need to put in config.json from saved fine-tuned Hugging Face model in
# code 
...
def predict_fn(input_data, model):
    ...
    input_ids = encode_plus_token['input_ids']
        ...
        # output is a tuple: 
        # output: (tensor([[-1.9840, -0.9870,  2.8947]],
        ...
        probability_list, prediction_label_list = torch.max(softmax_output,
                                                            dim=1)
